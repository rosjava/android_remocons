...
public class PlatformInfoServiceClient extends AbstractNodeMain {
    ...
    private String uniqueName; // unique robot name, simply the above with stripped '/''s.
     ...
     *
     * @throws org.ros.exception.ServiceNotFoundException : when it times out waiting for the service.
     */
    ...
    public String getConcertNamespace() {
        return this.namespace;
    }

    /**
     * Concert unique name is simply the unadorned app manager namespace (i.e. no '/').
     * @return
     */
    ...
    public String getConcertType() {
        return this.platformInfo.getSystem();
    }

    public Icon getConcertIcon() {
        ...
        while ( this.namespace == null ) {
            ...
            for (TopicSystemState topic : systemState.getTopics()) {
                ...
                if ( graph_name.getBasename().toString().equals("app_list") ) {
                    ...
                    this.uniqueName = graph_name.getParent().toRelative().toString();
